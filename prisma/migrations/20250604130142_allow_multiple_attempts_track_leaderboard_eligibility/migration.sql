...
CREATE TABLE "new_daily_puzzle_entries" (
    ...
    "countsForLeaderboard" BOOLEAN NOT NULL DEFAULT true,
...
CREATE UNIQUE INDEX "daily_puzzle_entries_userId_puzzleId_attemptNumber_key" ON "daily_puzzle_entries"("userId", "puzzleId", "attemptNumber");
